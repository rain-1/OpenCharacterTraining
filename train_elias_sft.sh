...
DATA_PATH="/home/ubuntu/OpenCharacterTraining/data/sft_data/meta-llama/Llama-3.1-8B-Instruct/elias_vance.jsonl"
SAVE_PATH="/home/ubuntu/OpenCharacterTraining/loras/elias_sft"
...
openrlhf.cli.train_sft \
    ...
    --wandb_run_name elias_vance_sft \
    --lora_rank 64 \
    --lora_alpha 128
EOF
